...
| `WS-20` Guest experience | `DSB-BOP-P2-003` to `DSB-BOP-P2-005`, `DSB-BOP-P6-009`, `DSB-BOP-P6-010` | Public wall route, approved-post view, consent-aware contribution model, self-service ownership contract and discreet acquisition footer | Mobile UI tests plus emulator rules tests cover read/create/edit/delete boundaries and the footer reaches the landing page |
